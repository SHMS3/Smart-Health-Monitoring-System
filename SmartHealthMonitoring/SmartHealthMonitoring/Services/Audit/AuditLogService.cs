...
namespace SmartHealthMonitoring.Services.Audit;
...
public class AuditLogService : IAuditLogService
{
    ...
    public async Task<(List<AuditLogListItemViewModel> Items, int TotalCount)> GetFilteredLogsAsync(
    ...
    public async Task<List<AuditLogActorOptionViewModel>> GetActorOptionsAsync()
    {
