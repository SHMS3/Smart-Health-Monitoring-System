...
namespace SmartHealthMonitoring.Interfaces.Receptionist
{
    public interface IReceptionistService
    {
        ...
        Task<PagedResult<SmartHealthMonitoring.Models.Patient>> GetPatientsAsync(string search, int page, int pageSize);
        Task<SmartHealthMonitoring.Models.Patient?> GetPatientDetailsAsync(int id);
